...
class PaqueteControllerTest {
  ...
  @MockBean private PaqueteServiceImpl paqueteService;
  ...
  void testGetAllPaquetes() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/paquetes"))
  ...
  void testGetPaqueteById() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/paquetes/1"))
        .andExpect(status().isOk())
  ...
  void testSavePaquete() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/paquetes")
