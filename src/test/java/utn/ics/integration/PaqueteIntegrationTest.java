...
public class PaqueteIntegrationTest {
    ...
    void testFindPaqueteByTitulo() throws Exception{
        ...
        Marca marca1 = Marca.builder()
                .nombre("Nike")
                .descripcion("Indumentaria deportiva Nike")
                .build();
        ...
        try {
            this.mockMvc.perform(get("/paquetes/nombre=Paquete Deporte").contentType(MediaType.APPLICATION_JSON))
